...
public class LoginView extends LoginOverlay
	...
	public LoginView() {
		// SHOW CALL TO ACTION
		com.vaadin.starter.bakery.ui.components.CTA.show();

		// CALL TO GOOGLE ANALYTICS
		com.vaadin.flow.component.UI.getCurrent().getPage()
				.executeJs("(function(i,s,o,g,r,a,m) {i['GoogleAnalyticsObject']=r;i[r]=i[r]||function()"
						+ "{ (i[r].q=i[r].q||[]).push(arguments)}" + "    ,i[r].l=1*new Date();a=s.createElement(o),"
						+ "    m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)"
						+ "})(window,document,'script','https://www.google-analytics.com/analytics.js','ga');"
						+ "ga('create', 'UA-658457-6', 'auto');" + "ga('send', 'pageview');");
